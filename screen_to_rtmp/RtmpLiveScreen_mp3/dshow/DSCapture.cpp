...
void DSCapture::SetCaptureWebcam(bool isCapture)
{
    if (video_encoder_thread_)
    {
        video_encoder_thread_->SetCaptureWebcam(isCapture);
    }
}

void DSCapture::SetWebcamPosition(int x, int y)
{
    if (video_encoder_thread_)
    {
        video_encoder_thread_->SetWebcamPosition(x, y);
    }
}
